...
// 1) 'description' : debe ser igual a la descripción pasada como parámetro al varructor
// 2) 'complete'    : debe setearse en false
// Ayuda: usar 'this' en el varructor
...
function addToDo() {
  ...
  var valorImput = input.value;
  var newTodo = new ToDo(valorImput);
